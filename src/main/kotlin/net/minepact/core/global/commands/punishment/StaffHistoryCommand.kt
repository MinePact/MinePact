...
class StaffHistoryCommand : Command(
    ...
    override fun execute(
        ...
        var punishments: List<Punishment> = PunishmentRepository.findByIssuer(target).get()
        sender.send("")
        sender.send("<green>Last $limit punishments from <white>$target<green>:")
